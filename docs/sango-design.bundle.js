...
:host(.selection-card) { cursor: grab; }
...
.player-role, .player-role-marker { width: 1.25rem; max-width: 1.25rem; padding: 0; border-radius: 50%; font-size: 0.625rem; line-height: 1; }
:host(.current-player) .player-info::after { display: none; }
.player-role.king, :host(.current-player) .player-role { display: grid; color: #ffe0a0; border-color: #c98b39; background: rgba(181, 76, 31, 0.22); }
:host(.current-player) .player-role-marker, .player-role.king ~ .player-role-marker { display: none; }
